...
namespace IntecoAG.XafExt.Spreadsheet.MultiDimForms {
    ...
    [Persistent("FmMdfReportForm")]
    public abstract class MdfReportForm : IagBaseObject { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).

        public abstract MdfTemplateForm TemplateForm { get; }
        ...
        protected MdfReportForm(Session session)
            : base(session) {
        }
