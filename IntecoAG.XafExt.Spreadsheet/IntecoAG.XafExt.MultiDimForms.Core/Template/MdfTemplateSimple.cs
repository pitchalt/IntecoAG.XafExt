...
namespace IntecoAG.XafExt.Spreadsheet.MultiDimForms {
    ...
    public class MdfTemplateSimple : MdfTemplate { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        public MdfTemplateSimple(Session session)
            : base(session) {
        }
